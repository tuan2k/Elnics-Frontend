                ...
                <div class="page-sidebar-inner slimscroll">
                    <ul class="accordion-menu">
                        ...
                        <li class="active-page">
                            <router-link to="/dashboard" class="active"><i class="material-icons-outlined">dashboard</i>Dashboard</router-link>
                        </li>
                        <li>
                            <router-link to="/mailbox"><i class="material-icons-outlined">inbox</i>Mailbox</router-link>
                        </li>
                        <li>
